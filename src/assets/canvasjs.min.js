...
(function() {
    ...
    if (k && p && D) {
      ...
      if (!u)
        try {
          ...
          (p = window.open()),
            p.document.write(
              "<img src='" + k + "'></img><div>Please right click on the image and save it to your device</div>"
            ),
            p.document.close();
        }
    }
  ...
  function ua(k, p, D) {
    p.getAttribute('state') ||
      ...
      (p.style.border = 'none'),
      sa(k, p, { WebkitUserSelect: 'none', MozUserSelect: 'none', msUserSelect: 'none', userSelect: 'none' }));
      ...
      : this.parent &&
        ...
        (null === r
          ...
          : 0 < this.parent.themeOptions[p].length &&
            ((r = Math.min(this.parent.themeOptions[p].length - 1, r)), (k = this.parent.themeOptions[p][r])));
    this.themeOptions = k;
  ...
  var X = 20,
    ...
    Xa = {
      ...
      subtitles: [
        { fontFamily: Ha, fontSize: E, fontColor: fa, fontWeight: 'normal', verticalAlign: 'top', margin: 5 }
      ],
      data: [
        {
  ...
  var X = 20,
    ...
    cb = {
      ...
      subtitles: [
        { fontFamily: v, fontSize: E, fontColor: '#3A3A3A', fontWeight: 'normal', verticalAlign: 'top', margin: 5 }
      ],
      data: [
        {
          indexLabelFontFamily: v,
  ...
  var X = 20,
    ...
    ya = {
      ...
      dark2: {
        ...
        subtitles: [
          { fontFamily: v, fontSize: E, fontColor: fa, fontWeight: 'normal', verticalAlign: 'top', margin: 5 }
        ],
        toolbar: {
          backgroundColor: '#666666',
          backgroundColorOnHover: '#FF7372',
  ...
  V.prototype.set = function(k, p, r) {
    ...
    if ('options' === k) this.createUserOptions(p);
      ...
      u.hasOwnProperty(k) ||
      (u.publicProperties && u.publicProperties.hasOwnProperty(k) && 'readWrite' === u.publicProperties[k])
    )
      this.options._isPlaceholder && this.createUserOptions(), (this.options[k] = p);
    else {
      window.console &&
        (u.publicProperties && u.publicProperties.hasOwnProperty(k) && 'readOnly' === u.publicProperties[k]
  ...
  V.prototype.addTo = function(k, p, r, u) {
    ...
    v.hasOwnProperty(k) ||
    (v.publicProperties && v.publicProperties.hasOwnProperty(k) && 'readWrite' === v.publicProperties[k])
      ...
      : window.console &&
        (v.publicProperties && v.publicProperties.hasOwnProperty(k) && 'readOnly' === v.publicProperties[k]
          ? window.console.log('Property "' + k + '" is read-only.')
          : window.console.log('Property "' + k + '" doesn\'t exist. Please check for typo.'));
  };
      ...
      : this.parent &&
        ...
        (null === H
          ...
          : 0 < this.parent.themeOptions[E].length &&
            ((r = Math.min(this.parent.themeOptions[E].length - 1, H)), (r = this.parent.themeOptions[E][r])));
    this.themeOptions = r;
  ...
  Aa.prototype.setLayout = function() {
    if (this.text) {
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? (null === this.maxWidth && (this.maxWidth = p.width - 4 - F * ('center' === this.horizontalAlign ? 2 : 1)),
      ...
      u(this.padding) || 'number' !== typeof this.padding
        ? u(this.padding) ||
          ...
          ((L = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0),
  ...
  Na.Chart = (function() {
    ...
    function E(a, d, b, c, e, g, m, l, w, h) {
      ...
      w && 0 < m.thickness
        ...
        : 0 < m.thickness && (a.moveTo(d, b + s), a.lineTo(c, b + s), a.moveTo(d, e - s), a.lineTo(c, e - s));
      a.stroke();
      a.restore();
    }
    ...
    function z(a, d, b, c, e, g) {
      ...
      this.options.scaleBreaks &&
        (this.scaleBreaks = new Q(this.chart, this.options.scaleBreaks, ++this.chart._eventManager.lastObjectId, this));
      this.stripLines = [];
      if (this.options.stripLines && 0 < this.options.stripLines.length)
        for (a = 0; a < this.options.stripLines.length; a++)
          this.stripLines.push(
            new X(this.chart, this.options.stripLines[a], a, ++this.chart._eventManager.lastObjectId, this)
          );
              ...
              d
                ...
                : (sa(a, a._zoomButton, {
                  ...
                  0 >= navigator.userAgent.search('MSIE') &&
                    sa(a, a._zoomButton.childNodes[0], { WebkitFilter: 'invert(100%)', filter: 'invert(100%)' }));
            },
            this.allDOMEventHandlers
          );
          O(
            ...
            function() {
              d ||
                ...
                0 >= navigator.userAgent.search('MSIE') &&
                  sa(a, a._zoomButton.childNodes[0], { WebkitFilter: 'invert(0%)', filter: 'invert(0%)' }));
            },
            this.allDOMEventHandlers
          );
        }
          ...
          O(
            ...
            function() {
              d ||
                ...
                0 >= navigator.userAgent.search('MSIE') &&
                  sa(a, a._resetButton.childNodes[0], { WebkitFilter: 'invert(100%)', filter: 'invert(100%)' }));
            },
            this.allDOMEventHandlers
          ),
          O(
            ...
            function() {
              d ||
                ...
                0 >= navigator.userAgent.search('MSIE') &&
                  sa(a, a._resetButton.childNodes[0], { WebkitFilter: 'invert(0%)', filter: 'invert(0%)' }));
            },
            this.allDOMEventHandlers
          ),
          ...
          O(
            ...
            function() {
              d ||
                ...
                0 >= navigator.userAgent.search('MSIE') &&
                  sa(a, a._menuButton.childNodes[0], { WebkitFilter: 'invert(100%)', filter: 'invert(100%)' }));
            },
            this.allDOMEventHandlers,
            !0
          ),
          O(
            ...
            function() {
              d ||
                ...
                0 >= navigator.userAgent.search('MSIE') &&
                  sa(a, a._menuButton.childNodes[0], { WebkitFilter: 'invert(0%)', filter: 'invert(0%)' }));
            },
            this.allDOMEventHandlers,
            !0
          ));
    ...
    p.prototype._updateSize = function() {
      ...
      this.options.height
        ? (b = this.height)
        : (this.height = b = 0 < this.container.clientHeight ? this.container.clientHeight : this.height);
    ...
    p.prototype._initialize = function() {
      this.isNavigator =
        u(this.parent) || u(this.parent._defaultsKey) || 'Navigator' !== this.parent._defaultsKey ? !1 : !0;
            ...
            if (this.options.axisY && 0 < this.options.axisY.length) {
              if (!this.axisY.length)
                for (var b = 0; b < this.options.axisY.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ...
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push(
                        (this.axisY[b] = new z(this, 'axisY', this.options.axisY[b], b, 'axisY', 'bottom'))
                      );
              ...
              this.axisY.length ||
                ('normal' === this.plotInfo.axisPlacement
                  ...
                  : 'xySwapped' === this.plotInfo.axisPlacement &&
                    this._axes.push((this.axisY[0] = new z(this, 'axisY', this.options.axisY, 0, 'axisY', 'bottom')))),
            ...
            if (this.options.axisY2 && 0 < this.options.axisY2.length) {
              if (!this.axisY2.length)
                for (b = 0; b < this.options.axisY2.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ? this._axes.push(
                        (this.axisY2[b] = new z(this, 'axisY2', this.options.axisY2[b], b, 'axisY', 'right'))
                      )
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push(
                        (this.axisY2[b] = new z(this, 'axisY2', this.options.axisY2[b], b, 'axisY', 'top'))
                      );
              ...
              this.axisY2.length ||
                ('normal' === this.plotInfo.axisPlacement
                  ...
                  : 'xySwapped' === this.plotInfo.axisPlacement &&
                    this._axes.push((this.axisY2[0] = new z(this, 'axisY2', this.options.axisY2, 0, 'axisY', 'top')))),
            ...
            if (this.options.axisX && 0 < this.options.axisX.length) {
              if (!this.axisX.length)
                for (b = 0; b < this.options.axisX.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ? this._axes.push(
                        (this.axisX[b] = new z(this, 'axisX', this.options.axisX[b], b, 'axisX', 'bottom'))
                      )
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push(
                        (this.axisX[b] = new z(this, 'axisX', this.options.axisX[b], b, 'axisX', 'left'))
                      );
              ...
              this.axisX.length ||
                ('normal' === this.plotInfo.axisPlacement
                  ...
                  : 'xySwapped' === this.plotInfo.axisPlacement &&
                    this._axes.push((this.axisX[0] = new z(this, 'axisX', this.options.axisX, 0, 'axisX', 'left')))),
            ...
            if (this.options.axisX2 && 0 < this.options.axisX2.length) {
              if (!this.axisX2.length)
                for (b = 0; b < this.options.axisX2.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ? this._axes.push(
                        (this.axisX2[b] = new z(this, 'axisX2', this.options.axisX2[b], b, 'axisX', 'top'))
                      )
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push(
                ...
                (w = b[e]),
                  1 > a && 'undefined' !== typeof w.startTimePercent
                    ? a >= w.startTimePercent &&
                      w.animationCallback(w.easingFunction(a - w.startTimePercent, 0, 1, 1 - w.startTimePercent), w)
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          for (n = 0; n < q.dataPoints.length; n++) {
            ...
            if (0 < n) {
              ...
              null !== e &&
                ...
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((r = e / q.dataPoints[n - 1].y), 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r))
        ...
        for (n in l)
          l.hasOwnProperty(n) &&
            ...
            n < b.viewPortMin ||
              n > b.viewPortMax ||
              (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, h))));
      }
    };
    p.prototype._processStacked100PlotUnit = function(a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, m = !1, l = !1, w = [], h = 0;
          ...
          for (q = 0; q < s.dataPoints.length; q++) {
            ...
            if (0 < q) {
              ...
              u(e) ||
                ...
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((t = e / s.dataPoints[q - 1].y), 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t))
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          ...
          for (s = 0; s < h.dataPoints.length; s++) {
            ...
            0 < s &&
              (a.axisX.logarithmic
                ? ((B = c / h.dataPoints[s - 1].x), 1 > B && (B = 1 / B), b.minDiff > B && 1 !== B && (b.minDiff = B))
                : ((B = c - h.dataPoints[s - 1].x), 0 > B && (B *= -1), b.minDiff > B && 0 !== B && (b.minDiff = B)),
              e &&
            ...
            if (!(c < r) || q) {
              ...
              null === e
                ...
                : (g < d.viewPortMin && (d.viewPortMin = g), m > d.viewPortMax && (d.viewPortMax = m));
            }
          }
              ...
              if (!(4 > k.dataPoints.length))
                for (w = 0; w < k.dataPoints.length; w++)
                  if (
                    (c &&
                      ((q =
                        ((l + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                    ...
                    if ((g = 'waterfall' === a.type ? k.dataPointEOs[w].cumulativeSum : k.dataPoints[w].y) && g.length)
                      ...
                      u(g) ||
                        ((q = Math.floor((g - m) / r)), g < d[q].min && (d[q].min = g), g > d[q].max && (d[q].max = g));
                  }
            }
        }
      }
            ...
            if (this._axes[m].dataInfo.dataPointYNegativeSums) {
              ...
              for (l in n)
                n.hasOwnProperty(l) &&
                  ...
                  ((q = -1 * n[l]),
                  u(q) ||
                    ((f = Math.floor((q - w) / c)), q < s[f].min && (s[f].min = q), q > s[f].max && (s[f].max = q)));
            ...
            for (l = 0; l < Math.min(g.length, this._axes[m].scaleBreaks.maxNumberOfAutoBreaks); l++)
              (c = a(
                ...
                this._axes[m].scaleBreaks.autoBreaks.push(
                  new L(this, 'autoBreaks', c, l, ++this._eventManager.lastObjectId, this._axes[m].scaleBreaks)
                ),
                this._axes[m].scaleBreaks._appliedBreaks.push(
                  this._axes[m].scaleBreaks.autoBreaks[this._axes[m].scaleBreaks.autoBreaks.length - 1]
                );
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            ...
            'inside' !== t
              ? ((e = b.y1),
                ...
                0 < ma
                  ? ((n = h.point.y - w - m - c),
                    n < e && ((n = 'auto' === t ? Math.max(h.point.y, e) + m + c : e + m + c), (v = n + w > h.point.y)))
                  : ((n = h.point.y + m + c),
                    n > g - w - m - c &&
                      ((n = 'auto' === t ? Math.min(h.point.y, g) - w - m - c : g - w - m - c), (v = n < h.point.y))))
              : ((e = Math.max(h.bounds.y1, b.y1)),
                ...
                0 < ma
                  ? ((n = Math.max(h.point.y, c) - w / 2),
                    n < e && ('bubble' === s || 'scatter' === s) && (n = Math.max(h.point.y - w - m, b.y1 + m)))
              ...
              'inside' !== t
                ? ((m = b.x1),
                  ...
                  0 > ma
                    ? ((q = h.point.x - l - e - c),
                      q < m &&
                        ((q = 'auto' === t ? Math.max(h.point.x, m) + e + c : m + e + c), (v = q + l > h.point.x)))
                    : ((q = h.point.x + e + c),
                      q > g - l - e - c &&
                        ((q = 'auto' === t ? Math.min(h.point.x, g) - l - e - c : g - l - e - c), (v = q < h.point.x))))
          ...
          p &&
            'inside' !== t &&
              ((0 > s.indexOf('bar') && ('error' !== s || !h.axisSwapped) && h.point.x > b.x1 && h.point.x < b.x2) ||
                !v) &&
              ((0 > s.indexOf('column') && ('error' !== s || h.axisSwapped) && h.point.y > b.y1 && h.point.y < b.y2) ||
                !v) &&
            ((d.lineWidth = p),
            ...
            0 <= s.indexOf('bar') || ('error' === s && h.axisSwapped)
              ...
              ? d.lineTo(q + l / 2, n + ((0 < h.direction ? w : -w) + ('horizontal' === C ? w : -w)) / 2)
              : d.lineTo(q + l / 2, n + ((n < h.point.y ? w : -w) + ('horizontal' === C ? w : -w)) / 2),
            d.stroke());
        }
      }
      d = {
                ...
                if ('number' !== typeof s[t].y)
                  ...
                  p || u
                    ? (!p && h.connectNullData
                        ? (b.setLineDash &&
                            (h.options.nullDataLineDashType ||
                              (q === h.lineDashType && h.lineDashType !== h.nullDataLineDashType)) &&
                            (b.stroke(),
                            b.beginPath(),
                            b.moveTo(m.x, m.y),
                    ...
                    : (b.lineTo(C, x),
                      r && c.lineTo(C, x),
                      0 == t % 500 &&
                        (b.stroke(), b.beginPath(), b.moveTo(C, x), r && (c.stroke(), c.beginPath(), c.moveTo(C, x))));
                  m = { x: C, y: x };
                  t < s.length - 1 &&
                  ...
                  (s[t].indexLabel || h.indexLabel || s[t].indexLabelFormatter || h.indexLabelFormatter) &&
              ...
              if (
                ...
                if ('number' !== typeof s[p].y)
                  0 < p &&
                    ...
                    (h.connectNullData
                      ? c.setLineDash &&
                        0 < x.length && (h.options.nullDataLineDashType || !s[p - 1].lineDashType) &&
                  ...
                  p < s.length - 1 &&
                    ...
                    c.setLineDash &&
                      (s[p].lineDashType
                        ? ((q = s[p].lineDashType), (x[x.length - 1].newLineDashArray = R(q, h.lineThickness)))
                  ...
                  (s[p].indexLabel || h.indexLabel || s[p].indexLabelFormatter || h.indexLabelFormatter) &&
                    this._indexLabels.push({
                      chartType: 'spline',
                      dataPoint: s[p],
                      dataSeries: h,
          ...
          if (0 < B.length)
            for (var p = 5 < q && f.bevelEnabled ? !0 : !1, g = 0; g < B.length; g++)
              if (
                ...
                m = a.axisX.reversed
                  ? (m + (a.plotType.totalDataSeries * q) / 2 - (a.previousDataSeriesCount + s) * q) << 0
                  : (m - (a.plotType.totalDataSeries * q) / 2 + (a.previousDataSeriesCount + s) * q) << 0;
    ...
    p.prototype.renderStackedColumn = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        f = this.options.dataPointWidth
          ...
          : (0.9 *
              ((e.width *
                (a.axisX.logarithmic ? Math.log(f) / Math.log(a.axisX.range) : Math.abs(f) / Math.abs(a.axisX.range))) /
          ...
          if (0 < t.length) {
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  a.axisY.logarithmic ||
                  (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y)
                )
                  (l[c] = t[h].y + (l[c] ? l[c] : 0)),
                    0 < l[c] &&
                ...
                (t[h].indexLabel || p.indexLabel || t[h].indexLabelFormatter || p.indexLabelFormatter) &&
                  this._indexLabels.push({
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (l[c] = t[h].y + (l[c] ? l[c] : 0)),
                    0 < l[c] && ((y = g[c] ? g[c] : n), (g[c] = s = a.axisY.convertValueToPixel(l[c])));
                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y)
                  (w[c] = t[h].y + (w[c] ? w[c] : 0)),
                    (s = m[c] ? m[c] : n),
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (w[c] = x + (w[c] ? w[c] : 0)), (s = m[c] ? m[c] : n), (m[c] = x = a.axisY.convertValueToPixel(w[c]));
            ...
            for (var da = !0; k < p.length; k++)
              if (
                ...
                if ('number' !== typeof p[k].y) B.connectNullData || da || d || c(), (da = !0);
                    ...
                    ? (!d && B.connectNullData
                        ? (g.setLineDash &&
                            (B.options.nullDataLineDashType ||
                              (b === B.lineDashType && B.lineDashType !== B.nullDataLineDashType)) &&
                            ((d = t),
                            (b = u),
                            (t = q.x),
                            (u = q.y),
                          ...
                          g.lineTo(t, u),
                          r && m.lineTo(t, u))
                        : (g.beginPath(), g.moveTo(t, u), r && (m.beginPath(), m.moveTo(t, u)), (A = { x: t, y: u })),
                      (da = d = !1))
                  ...
                  (p[k].indexLabel || B.indexLabel || p[k].indexLabelFormatter || B.indexLabelFormatter) &&
                    this._indexLabels.push({
                      chartType: 'area',
                      dataPoint: p[k],
                      dataSeries: B,
              ...
              if (
                ...
                if ('number' !== typeof n[f].y)
                  0 < f &&
                    ...
                    (q.connectNullData
                      ? c.setLineDash &&
                        0 < x.length && (q.options.nullDataLineDashType || !n[f - 1].lineDashType) &&
                  ...
                  f < n.length - 1 &&
                    ...
                    c.setLineDash &&
                      (n[f].lineDashType
                        ? ((z = n[f].lineDashType), (x[x.length - 1].newLineDashArray = R(z, q.lineThickness)))
                  ...
                  : ((t = a.axisX.convertValueToPixel(x)),
                    ...
                    d || b
                      ? (!d && B.connectNullData
                          ? (g.setLineDash &&
                              (B.options.nullDataLineDashType ||
                                (Y === B.lineDashType && B.lineDashType !== B.nullDataLineDashType)) &&
                              ((d = t),
                              (b = u),
                              (t = q.x),
                              (u = q.y),
                          ...
                          : (g.beginPath(), g.moveTo(t, u), r && (m.beginPath(), m.moveTo(t, u)), (A = { x: t, y: u })),
                        (b = d = !1))
                      : (g.lineTo(t, Z), r && m.lineTo(t, Z), g.lineTo(t, u), r && m.lineTo(t, u), 0 == p % 250 && c()),
                    (q = { x: t, y: u }),
                    p < k.length - 1 &&
                      (T !== (k[p].lineColor || aa) || Y !== (k[p].lineDashType || B.lineDashType)) &&
                      (c(),
                      (T = k[p].lineColor || aa),
                      (g.strokeStyle = T),
                      g.setLineDash &&
        ...
        for (v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          if (0 < s.length) {
            ...
            for (var da = !0, n = 0; n < s.length; n++) {
              ...
              if (
                !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da)))
              )
                if ('number' !== typeof Z.y) A.connectNullData || da || C || d(), (da = !0);
                  ...
                  C || da
                    ? (!C && A.connectNullData
                        ? (c.setLineDash &&
                            (A.options.nullDataLineDashType ||
                              (x === A.lineDashType && A.lineDashType !== A.nullDataLineDashType)) &&
                            ((C = h.pop()),
                            (x = h[h.length - 1]),
                            d(),
                            c.moveTo(t.x, t.y),
                    ...
                    : (c.lineTo(f, k),
                      r && u.lineTo(f, k),
                      0 == n % 250 && (d(), c.moveTo(f, k), r && u.moveTo(f, k), h.push({ x: f, y: p - oa })));
                  t = { x: f, y: k };
                  n < z.length - 1 &&
                ...
                if ('number' !== typeof Z.y) A.connectNullData || da || u || d(), (da = !0);
                  ...
                  u || da
                    ? (!u && A.connectNullData
                        ? (c.setLineDash &&
                            (A.options.nullDataLineDashType ||
                              (t === A.lineDashType && A.lineDashType !== A.nullDataLineDashType)) &&
                            ((u = h.pop()),
                            (t = h[h.length - 1]),
                            d(),
                            c.moveTo(p.x, p.y),
                    ...
                    : (c.lineTo(f, k),
                      r && x.lineTo(f, k),
                      0 == n % 250 && (d(), c.moveTo(f, k), r && x.moveTo(f, k), h.push({ x: f, y: C - la })));
                  p = { x: f, y: k };
                  n < z.length - 1 &&
    ...
    p.prototype.renderBubble = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var k = 25 * Math.PI, p = Math.max(Math.pow((0.25 * Math.min(c.height, c.width)) / 2, 2) * Math.PI, k), h = 0;
          h < a.dataSeriesIndexes.length;
          h++
        )
            ...
            for (var q = 0, n = 0, e = 0; e < s.length; e++)
              if (
                ...
                (Math.sqrt((q - g) * (q - g) + (n - m) * (n - m)) < Math.min(f.size, 5) &&
                  ...
                  (s[e].indexLabel || h.indexLabel || s[e].indexLabelFormatter || h.indexLabelFormatter) &&
                    this._indexLabels.push({
                      chartType: 'scatter',
                      dataPoint: s[e],
                      dataSeries: h,
              ...
              if (
                ...
                r &&
                  ...
                  0 < Y &&
                    ...
                    c.lineTo(l - da / 2, w + Z),
                    c.stroke()));
                (x[m].indexLabel || C.indexLabel || x[m].indexLabelFormatter || C.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: C.type,
                    dataPoint: x[m],
                    dataSeries: C,
    ...
    p.prototype.renderRangeColumn = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        h = this.options.dataPointWidth
          ...
          : (0.9 *
              ((e.width *
                (a.axisX.logarithmic ? Math.log(h) / Math.log(a.axisX.range) : Math.abs(h) / Math.abs(a.axisX.range))) /
                a.plotType.totalDataSeries)) <<
            0;
        this.dataPointMaxWidth &&
          g > m &&
            ...
            for (var k = 5 < h && n.bevelEnabled ? !0 : !1, g = 0; g < f.length; g++)
              if (
                ...
                var p = a.axisX.reversed
                    ? (c + (a.plotType.totalDataSeries * h) / 2 - (a.previousDataSeriesCount + s) * h) << 0
                    : (c - (a.plotType.totalDataSeries * h) / 2 + (a.previousDataSeriesCount + s) * h) << 0,
          ...
          if (0 < k.length) {
            ...
            for (g = 0; g < k.length; g++)
              if (
                ...
                w = a.axisX.reversed
                  ? (w + (a.plotType.totalDataSeries * s) / 2 - (a.previousDataSeriesCount + q) * s) << 0
                  : (w - (a.plotType.totalDataSeries * s) / 2 + (a.previousDataSeriesCount + q) * s) << 0;
                ...
                if (
                  ...
                  n || T
                    ? (s.connectNullData && !n
                      ...
                      (T = n = !1))
                    : (c.lineTo(k, p), w.push({ x: k, y: u }), r && e.lineTo(k, p), 0 == f % 250 && d());
                  t = s.dataPointIds[f];
                  this._eventManager.objectMap[t] = {
                    id: t,
                    objectType: 'dataPoint',
              ...
              if (
                ...
                if (
                  ...
                  q < k.length - 1 &&
                    ...
                    c.setLineDash &&
                      (k[q].lineDashType
                        ? ((F = k[q].lineDashType), (u[u.length - 1].newLineDashArray = R(F, h.lineThickness)))
                  ...
                  0 < q &&
                    ...
                    (h.connectNullData
                      ? c.setLineDash &&
                        0 < u.length && (h.options.nullDataLineDashType || !k[q - 1].lineDashType) &&
          ...
          if (0 < v.length)
            for (var x = 5 < n && u.bevelEnabled ? !0 : !1, z = !1, y = null, A = null, m = 0; m < v.length; m++)
              if ((v[m].getTime ? (s = v[m].x.getTime()) : (s = v[m].x), 'number' !== typeof v[m].y)) {
                ...
                l = a.axisX.reversed
                  ? (l + (a.plotType.totalDataSeries * n) / 2 - (a.previousDataSeriesCount + f) * n) << 0
                  : (l - (a.plotType.totalDataSeries * n) / 2 + (a.previousDataSeriesCount + f) * n) << 0;
                ...
                var Y,
                  T = l;
                Y =
                  ('undefined' !== typeof v[m].isIntermediateSum && !0 === v[m].isIntermediateSum) ||
                ...
                (v[m].indexLabel || u.indexLabel || v[m].indexLabelFormatter || u.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: 'waterfall',
                    dataPoint: v[m],
                    dataSeries: u,
          ...
          for (d = 0; d < s.length; d++)
            (m = f[(c + d) % s.length]),
              1 < a &&
                ...
                (g <= a / 2 && !q ? ((m.hemisphere = 'right'), g++) : ((m.hemisphere = 'left'), (q = !0)));
          q = !1;
          for (d = 0; d < s.length; d++)
            (m = f[(e + d) % s.length]),
              1 < b &&
                m.midAngle > (3 * Math.PI) / 2 - t && m.midAngle < (3 * Math.PI) / 2 + t &&
                (l <= b / 2 && !q ? ((m.hemisphere = 'left'), l++) : ((m.hemisphere = 'right'), (q = !0)));
        }
      }
      function b(a) {
          ...
          0 > b
            ...
            : 0 < b &&
              ...
              null !== l &&
                ...
                b - q < p &&
                  ((h = q), (l = g(l, h, d + 1)), +l.toFixed(C) < +h.toFixed(C) && (m = b > p ? b - p : q - (h - l)))));
          m &&
        ...
        for (var b = (a = 0), d = 0, m = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                ...
                if (0 > z) {
                  ...
                  'right' === l.hemisphere
                    ? ((H = g(a, u)),
                      (E = -1 * (z - H)),
                      (I = g(y, E)),
                      +I.toFixed(C) < +E.toFixed(C) && +H.toFixed(C) <= +u.toFixed(C) && g(a, -(E - I)))
                    : ((H = g(y, u)),
                      (E = -1 * (z - H)),
                      (I = g(a, E)),
          ...
          for (a = 0; a < s.length; a++)
            if (((l = f[a]), (y = l.indexLabelTextBlock.measureText()), 0 !== y.height && 0 !== y.width))
              (y = y = 0),
                'right' === l.hemisphere
                  ? ((y = n.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width + q)), (y *= -1))
                ...
                0 < y &&
                  ...
                  Math.abs(l.indexLabelTextBlock.x - x.x) < A &&
                    ((y /= Math.abs(Math.sin(l.indexLabelAngle))), 9 < y && (y *= 0.3), y > d && (d = y)));
              ...
              if (((g = !1), (t = f[l]), t.indexLabelText)) {
                ...
                if (null !== m) {
                  ...
                  if ((n = 0 > z)) {
                    ...
                    n =
                      t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < h.indexLabelTextBlock.x - q ||
                      n > u + q ||
                      k > r + q ||
                      w < p - q
                        ? !1
        ...
        for (var y = 0; y < s.length; y++)
          (z += Math.abs(s[y].y)),
            !a &&
              ...
              (a = !0),
            !a &&
              'undefined' !== typeof s[y].label && null !== s[y].label && 0 < s[y].label.toString().length &&
              (a = !0);
        if (0 !== z) {
          ...
          this._animator.animate(
            ...
            function(a) {
              ...
              for (b = 0; b < s.length; b++) {
                ...
                e > c &&
                  ja(k.plotArea.ctx, f[b].center, f[b].radius, g, h.type, c, e, h.fillOpacity, f[b].percentInnerRadius);
                if (d) break;
              }
              l();
            },
    ...
    var ra = function(a, d, b, c) {
      ...
      0 >= Math.round(d.y4 - d.y1) ||
        ...
        'undefined' !== d.x5 &&
          (a.lineTo(Math.round(d.x5), Math.round(d.y5)), a.lineTo(Math.round(d.x6), Math.round(d.y6))),
        a.closePath(),
    ...
    p.prototype.renderFunnel = function(a) {
        ...
        if (t && C) {
          ...
          for (var y = 0, A = C.length - 1; y < C.length || 0 <= A; y++, A--) {
            ...
            'inside' === t.indexLabelPlacement &&
              ...
              20 > p[y] &&
                ((p[y] = y !== fa ? (t.reversed ? P[y].x3 - P[y].x4 : P[y].x2 - P[y].x1) : P[y].x2 - P[y].x1),
                (p[y] /= 2)));
      ...
      function e() {
        ...
        for (
          var g,
            l = L - V - S / 2,
            l = t.options.indexLabelMaxWidth ? (t.indexLabelMaxWidth > l ? l : t.indexLabelMaxWidth) : l,
            h = J.length - 1;
          0 <= h;
          h--
        ) {
        ...
        if (d)
          for (h = J.length - 1; 0 <= h; h--)
            (a = P[h]),
              ...
              t.reversed
                ? (J[h].textBlock.y + J[h].height > pa + D && (J[h].textBlock.y = pa + D - J[h].height),
          ...
          for (var d = 0; d < P.length; d++)
            0 == J[d].textBlock.text.length
              ...
              : ((a = P[d]),
                ...
                t.reversed
                  ? (J[d].textBlock.y + J[d].height > pa + D && (J[d].textBlock.y = pa + D - J[d].height),
            ...
            for (var s = J.length - 1; 0 <= s; s--)
              !J[s].isDirty &&
                ...
                !(l >= J.length - 1) &&
                  ...
                  (J[s].textBlock.y =
                    J[s].textBlock.y + J[s].height - e > e - J[s].textBlock.y ? e + 1 : e - J[s].height - 1));
          }
        ...
        for (var d, e, f, g, h, m, k = 1, s = 0; s < 2 * k; s++) {
          for (
            ...
            !f.isDirty &&
              ...
              ((d = g.y + d + ga - m.y), (e = a(w, -d)), e < d && (0 < e && (d -= e), (e = a(n(w), d)), e != d)));
            w--
          );
          b();
        }
        ...
        for (
          ...
          if (
            (!H &&
              ...
              (H = !0),
            !H &&
              'undefined' !== typeof C[I].label && null !== C[I].label && 0 < C[I].label.toString().length &&
              (H = !0),
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== C.length) {
          ...
          if (-1 !== I) {
            ...
            if (H && t.visible && (c(), g(), e(), 'inside' !== t.indexLabelPlacement)) {
              ...
              for (G = 0; G < C.length; G++)
                J[G].isDirty ||
                  ((a = J[G].textBlock.x + J[G].width), (a = (L - a) / 2), 0 == G && (A = a), A > a && (A = a));
            ...
            H &&
              t.visible &&
              ('inside' === t.indexLabelPlacement || z.animationEnabled || s(Q), z.animationEnabled || p());
            if (!H)
              for (G = 0; G < C.length; G++)
                (A = t.dataPointIds[G]),
                  (a = {
    ...
    p.prototype.getPercentAndTotal = function(a, d) {
      ...
      if (0 <= a.type.indexOf('stacked'))
        (c = 0),
          ...
          b in a.plotUnit.yTotals && ((c = a.plotUnit.yTotals[b]), (e = isNaN(d.y) ? 0 : 100 * (d.y / c)));
          ...
          if ('pie' !== q.type && 'doughnut' !== q.type && 'funnel' !== q.type && 'pyramid' !== q.type) {
            var n = (q.legendMarkerType = q.legendMarkerType
              ...
              f = q.legendText
                ...
                ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: q, dataPoint: null })
                : q.name,
    ...
    F.prototype.getDataPointAtXY = function(a, d, b) {
      ...
      if ('none' !== this.chart.plotInfo.axisPlacement)
        if (
          ((q = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d })),
          this.axisX.logarithmic)
        )
          var n = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
            q =
              1 < n
                ? Math.min(
                    Math.max((((this.dataPoints.length - 1) / n) * Math.log(q / this.dataPoints[0].x)) >> 0, 0),
                    this.dataPoints.length
                  )
                : 0;
        else
          (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (q =
              0 < n
                ? Math.min(
                    Math.max((((this.dataPoints.length - 1) / n) * (q - this.dataPoints[0].x)) >> 0, 0),
                    this.dataPoints.length
                  )
                : 0);
      for (;;) {
            ...
            switch (this.type) {
              ...
              case 'doughnut':
                ...
                p < n.radius &&
                  ...
                  p > u &&
                    p < r &&
                    (c.push({ dataPoint: f, dataPointIndex: g, dataSeries: this, distance: 0 }), (l = !0)));
                break;
              case 'funnel':
              case 'pyramid':
                p = n.funnelSection;
                d > p.y1 &&
                  ...
                  a > g &&
                    a < p &&
                    (c.push({ dataPoint: f, dataPointIndex: n.dataPointIndex, dataSeries: this, distance: 0 }),
                    (l = !0)));
                break;
              case 'boxAndWhisker':
                if (
        ...
        if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
          for (
            var b = z.getNiceNumber(
                (d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3),
                !0
              ),
    ...
    z.prototype.createLabels = function() {
      ...
      if ('axisX' !== this.type || 'dateTime' !== this.valueType || this.logarithmic) {
        ...
        if (this.logarithmic && !this.equidistantInterval)
          for (
            this.logLabelValues || ((this.logLabelValues = []), this.createExtraLabelsForLog()), c = 0, f = n;
            ...
            for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
              if (!this._labels[b].breaksLabelType) {
                ...
                if (u(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                    ...
                    this.labelWrap
                      ...
                      ? ((this.sessionVariables.labelWrap = this.labelWrap),
                        ...
                        (B.width + d.width) >> 0 > 2 * g &&
                          ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = p)))
                      : ((this.sessionVariables.labelAngle =
                          this.sessionVariables.labelMaxWidth > g ? -25 : this.sessionVariables.labelAngle),
                        (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth),
                        (this.sessionVariables.labelMaxHeight = m),
                  ...
                  (p =
                    0 != this.labelAngle
                      ? (h - (k + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) /
                        Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))
                      : g),
            ...
            g =
              0 === this.labelAngle
                ...
                : e.width * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle)) +
                  (e.height - c.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle));
          a < g && (a = g);
    ...
    z.setLayout = function(a, d, b, c, e, g) {
      ...
      for (
        var z = (v = 0), t = 0, C = 0, x = 0, D = 0, y = 0, A, E, F = (l = 0), H, I, L, r = (H = I = L = !1), f = 0;
        f < n.length;
        f++
      )
        n[f] &&
          ...
          if (a && 0 < a.length)
            for (f = 0; f < a.length; f++)
              a[f] &&
                ...
                (a[f].bounds = { x1: m, y1: l, x2: k, y2: h - (V + e - C[f] - G), width: k - m, height: h - l })),
                (G += C[f] + a[f].margin);
          if (d && 0 < d.length)
            for (f = 0; f < d.length; f++)
              (d[f].lineCoordinates.x1 = Math.round(g.x1 + P + K)),
                ...
                (d[f].bounds = { x1: m, y1: l + (X + W - x[f] - R), x2: k, y2: h, width: k - m, height: h - l }),
                (R += x[f] + d[f].margin);
          if (b && 0 < b.length)
            for (f = 0; f < b.length; f++)
              (K = p.isNavigator ? 0 : 10),
                b[f] &&
                  ...
                  (b[f].lineCoordinates = { x1: k - S, y1: l, x2: k - S, y2: h, height: Math.abs(h - l) }),
                  (b[f].bounds = { x1: m - (D[f] + S), y1: l, x2: k, y2: h, width: k - m, height: h - l }),
                  b[f].title &&
              ...
              c[f] &&
                ...
                (K =
                  0 < a.length
                    ...
                    : 0),
                (h = Math.round(g.y2 - (V + e + K))),
                (c[f].lineCoordinates = { x1: m + U, y1: l, x2: m + U, y2: h, height: Math.abs(h - l) }),
                (c[f].bounds = { x1: m, y1: l, x2: k + (y[f] + U), y2: h, width: k - m, height: h - l }),
                c[f].title &&
              ...
              a[f] &&
                ...
                a[f]._labels &&
                  ...
                  (E = a[f].logarithmic
                    ...
                    : (0 < m ? m * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) + a[f].lineCoordinates.x1)));
          if (d && 0 < d.length)
            for (f = 0; f < d.length; f++)
              d[f].calculateValueToPixelConversionParameters(),
                ...
                d[f]._labels &&
                  ...
                  (E = d[f].logarithmic
                    ...
                    : (0 < m ? m * Math.abs(d[f].conversionParameters.pixelPerUnit) : 0) + d[f].lineCoordinates.x1));
          for (f = 0; f < n.length; f++)
            'axisY' === n[f].type &&
        ...
        for (N = []; 4 > v; ) {
            ...
            for (f = 0; f < b.length; f++)
              (b[f].lineCoordinates = {}),
                ...
                b[f].labelAutoFit &&
                  !u(C) &&
                  (0 < !a.length &&
                    (m = 0 > b[f].labelAngle ? Math.max(m, C) : 0 === b[f].labelAngle ? Math.max(m, C / 2) : m),
            ...
            for (f = 0; f < c.length; f++)
              (c[f].lineCoordinates = {}),
                ...
                c[f] &&
                  ...
                  !u(D) &&
                  (0 < !a.length &&
                    (m = 0 < c[f].labelAngle ? Math.max(m, D) : 0 === c[f].labelAngle ? Math.max(m, D / 2) : m),
                  0 < !d.length && (k -= y / 2)),
          ...
          if (c && 0 < c.length)
            for (f = c.length - 1; 0 <= f; f--)
              c[f] &&
                ...
                (c[f].bounds = { x1: m, y1: l + (c[f].margin + G), x2: k, y2: h, width: k - m, height: R }),
                c[f].title &&
                  (c[f]._titleTextBlock.maxWidth =
                    0 < c[f].titleMaxWidth && c[f].titleMaxWidth < c[f].lineCoordinates.width
                      ? c[f].titleMaxWidth
          ...
          if (a && 0 < a.length)
            for (f = 0; f < a.length; f++) {
              ...
              l =
                c && 0 < c.length
                  ? Math.round(c[0] ? c[0].lineCoordinates.y2 : g.y1 < Math.max(K, 10) ? Math.max(K, 10) : g.y1)
                  : g.y1 < Math.max(K, 10)
                  ? Math.max(K, 10)
                  : g.y1;
              ...
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
                    ((k = 0 > b[K].labelAngle ? Math.max(k, C) : 0 === b[K].labelAngle ? Math.max(k, C / 2) : k),
        ...
        if (null !== this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
          ...
          this.stripLines[a].value = this.logarithmic
            ? this.stripLines[a].value *
              Math.sqrt(Math.log(this.stripLines[a].endValue / this.stripLines[a].startValue) / Math.log(d))
            : this.stripLines[a].value +
        ...
        for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++)
          a[d].endValue < this.conversionParameters.minimum ||
            ...
            a[d].startValue >= this.conversionParameters.minimum &&
              ((a[d].startPixel = this.convertValueToPixel(a[d].startValue)), (this.scaleBreaks.lastBreakIndex = d)),
    ...
    z.prototype.renderStripLinesOfThicknessType = function(a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (
          ...
          h._thicknessType === a &&
            (('pixel' === a &&
              (h.value < this.viewportMinimum || h.value > this.viewportMaximum || u(h.value) || isNaN(this.range))) ||
              l.push(h));
        }
          ...
          a > e[g].endValue ||
            (a <= e[g].startValue && d >= e[g].endValue
              ...
              ? (b =
                  (b / d) *
                  e[g].startValue *
                  Math.pow(e[g].size, Math.log(d / e[g].startValue) / Math.log(e[g].endValue / e[g].startValue)))
              : !c &&
                a > e[g].startValue && d < e[g].endValue &&
                (b = a * Math.pow(e[g].size, Math.log(d / a) / Math.log(e[g].endValue / e[g].startValue))));
      } else
      ...
      if ('bottom' === this._position || 'top' === this._position)
        this.logarithmic
          ? ((d.lnLogarithmBase = Math.log(this.logarithmBase)),
            (d.pixelPerUnit = ((this.reversed ? -1 : 1) * b * d.lnLogarithmBase) / Math.log(Math.abs(c))))
    ...
    z.prototype.calculateAxisParameters = function() {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        !u(this.options.viewportMinimum) &&
          !u(this.options.viewportMaximum) && this.options.viewportMinimum >= this.options.viewportMaximum &&
        ...
        if ('axisX' === this.type && b) {
          ...
          this.interval =
            this.options && 0 < this.options.interval ? this.options.interval : z.getNiceNumber(c / (a - 1), !0);
        ...
        if (null === this.minimum || null === this.maximum)
          if (
            ...
            (this.intervalType = this.valueType = 'number'),
              null === this.minimum &&
                ((this.minimum = 'axisX' === this.type ? e - m / 2 : Math.floor(e / this.interval) * this.interval),
              ...
              null === this.maximum &&
                ((this.maximum = 'axisX' === this.type ? g + m / 2 : Math.ceil(g / this.interval) * this.interval),
    ...
    z.prototype.calculateLogarithmicAxisParameters = function() {
      ...
      if (this.scaleBreaks)
        for (m = 0; m < this.scaleBreaks._appliedBreaks.length; m++)
          if (
            ((!u(this.sessionVariables.newViewportMinimum) &&
              this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[m].startValue) ||
              (!u(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[m].startValue) ||
              (!u(this.options.viewportMinimum) &&
                this.viewportMinimum >= this.scaleBreaks._appliedBreaks[m].startValue)) &&
            ((!u(this.sessionVariables.newViewportMaximum) &&
              this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[m].endValue) ||
              (!u(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[m].endValue) ||
              (!u(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[m].endValue))
          ) {
      ...
      'axisX' === this.type
        ...
        : 'axisY' === this.type &&
          ...
          1 === c && 1 === e
            ...
            : 1 === e / c
            ? ((m = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))),
              (e *= m),
              (c /= m))
            : c > e
            ? ((m = Math.min((c / e) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))),
              1 <= e ? (c = e / m) : (e = c * m))
            : ((m = Math.min((e / c) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04))),
              1 !== e && (e *= m),
              1 !== c && (c /= m)),
          (g =
            Infinity !== this.dataInfo.minDiff
      ...
      this.options && 0 < this.options.interval
        ...
        : ((this.interval = z.getNiceExponent(Math.log(m) / d / (a - 1), !0)), (b = z.getNiceNumber(l / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          'axisX' === this.type
            ? c / Math.sqrt(g)
            : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(c) / d / this.interval));
      if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
        this.viewportMaximum =
          'axisX' === this.type
            ? e * Math.sqrt(g)
            : Math.pow(this.logarithmBase, this.interval * Math.ceil(Math.log(e) / d / this.interval));
    ...
    L.prototype.createUserOptions = function(a) {
      if ('undefined' !== typeof a || this.options._isPlaceholder) {
        ...
        this.options._isPlaceholder ||
          (Fa(this.parent[this.optionsName]), (d = this.parent.options[this.optionsName].indexOf(this.options)));
        ...
        if ('bottom' === this.scaleBreaks.parent._position || 'top' === this.scaleBreaks.parent._position)
          ...
          if (
            ...
            'left' === this.scaleBreaks.parent._position
              ...
              : ((c = this.chart.plotArea.x2), (m = (this.chart.plotArea.x1 - q / 2 + 0.5) << 0), (a *= -1)),
    ...
    fa.prototype.render = function(a, d) {
      ...
      if ('left' === this.parent._position || 'right' === this.parent._position)
        (this.labelMaxWidth = u(this.options.labelMaxWidth)
          ...
          : this.labelMaxWidth),
          (this.labelMaxHeight =
            u(this.options.labelWrap) || this.labelWrap ? 3 * this.chart.height : 2 * this.labelFontSize);
        ...
        (this.labelMaxWidth = u(this.options.labelMaxWidth) ? 3 * this.chart.width : this.labelMaxWidth),
          (this.labelMaxHeight =
            u(this.options.labelWrap) || this.labelWrap ? this.parent.bounds.height : 2 * this.labelFontSize);
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          if ('rangeBar' === m[0].dataSeries.type || 'error' === m[0].dataSeries.type)
            for (
              var f = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[0])), v = 0, n = 0;
              n < m.length;
              n++
            )
            ...
            for (
              var f = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), D = (v = 0), n = (r = 0);
              n < m.length;
              n++
            )
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
            ...
            for (
              var f = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), t = (D = v = 0), n = 0;
              n < m.length;
              n++
            )
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
          ...
          if (
            ...
            for (
              f = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), n = t = D = v = 0;
              n < m.length;
              n++
            )
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
          ...
          if (
            ...
            'waterfall' === this.parent.dataSeries[r].type
              ? ((m =
                  1 === p.lineWidth % 2
                    ? (this.parent.convertValueToPixel(k.dataSeries.dataPointEOs[k.index].cumulativeSum) << 0) + 0.5
                    : this.parent.convertValueToPixel(k.dataSeries.dataPointEOs[k.index].cumulativeSum) << 0),
                (l.text = this.labelFormatter
                  ? this.labelFormatter({
                      chart: this.chart,
                      axis: this.parent.options,
              ...
              for (var p = 0; p < this.chart.axisX.length; p++) {
                for (
                  ...
                  (h = this.chart.axisX[p].dataSeries[c].getDataPointAtX(k, b)) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX[p].dataSeries[c]), null !== h.dataPoint.y && l.push(h));
                h = null;
              }
              ...
              for (p = 0; p < this.chart.axisX2.length; p++) {
                ...
                for (c = 0; c < this.chart.axisX2[p].dataSeries.length; c++)
                  (h = this.chart.axisX2[p].dataSeries[c].getDataPointAtX(k, b)) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX2[p].dataSeries[c]), null !== h.dataPoint.y && l.push(h));
                h = null;
              }
          } else {
            l = [];
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (0 <= this.currentDataPointIndex)
              (c = e.dataPoints[this.currentDataPointIndex]),
                ...
                'waterfall' === e.type &&
                  ((h.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue),
          ...
          !1 === g.highlightEnabled ||
            ...
            'rangeSplineArea' === c.type
              ...
              ? (d.save(),
                ...
                (d.globalAlpha = 1))
              : 'error' === c.type &&
                E(d, e.x1, e.y1, e.x2, e.y2, 'white', e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3));
        }
      }
      d.restore();
      d.globalAlpha = 1;
            ...
            null === c.toolTipContent ||
              ...
              'waterfall' === b.type
                ? (this.chart.axisX &&
                    ...
                    (g += p != b.axisXIndex ? (b.axisX.title ? b.axisX.title + '<br/>' : 'X:{axisXIndex}<br/>') : ''),
                  (g += c.toolTipContent
                    ? c.toolTipContent
                    : b.toolTipContent
                    ? b.toolTipContent
              ...
              null === d && (d = ''),
              !0 === this.reversed
                ? ((d = this.chart.replaceKeywordsWithValue(g, c, b, e) + d), l < a.length - 1 && (d = '</br>' + d))
                : ((d += this.chart.replaceKeywordsWithValue(g, c, b, e)), l < a.length - 1 && (d += '</br>')));
        null !== d && (d = h + d);
      } else {
        b = a[0].dataSeries;
        c = a[0].dataPoint;
